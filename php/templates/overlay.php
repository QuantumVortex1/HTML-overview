        ...
        <form action="php/kontakt.php" method="post">
            <div class="form-contact-div">
                <div class="input-group">
                    <label class="form-label required" for="contact-input-1">Name</label>
                    <input required id="contact-input-1" type="text" name="name" autocomplete="off"
                        class="form-input">
                </div>
                <div class="input-group">
                    <label class="form-label required" for="contact-input-2">E-mail</label>
                    <input required id="contact-input-2" type="email" name="email" autocomplete="off"
                        class="form-input">
                </div>
            </div>
            <div class="input-group form-message">
                <label class="form-label required" for="form-message">Nachricht</label>
...
<div id="loginOverlay" class="overlay">
    <div class="form-container-login">
        ...
        <div class="form-login-div">
            <div class="input-group">
                <label class="form-label required" for="login-input-1">Benutzername</label>
                <input required id="login-input-1" type="text" name="loginusername" autocomplete="off"
                    class="form-input">
            </div>
            <div class="input-group">
                <label class="form-label required" for="login-input-2">E-Mail</label>
                <input required id="login-input-2" type="email" name="loginemail" autocomplete="off"
                    class="form-input">
            </div>
            <div class="input-group">
                <label class="form-label required" for="login-input-3">Passwort</label>
